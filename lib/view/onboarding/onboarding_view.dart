...
class _OnboardingViewState extends State<OnboardingView> {
  int page = 0;
  PageController? controller = PageController(); //Managed the page view control
  List pageArr = [
    {
      "title": "Discounted\nSecondhand Books",
  ...
  @override
  void initState() {
    //initialize the controller,set a listener to update the page variable when the page changes
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          PageView.builder(
            //Generates onboarding pages dynamically based on pageArr and Uses controller to manage page transitions.
